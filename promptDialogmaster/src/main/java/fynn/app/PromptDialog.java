...
@SuppressLint("InflateParams") public class PromptDialog extends Dialog {
	...
	public static final int VIEW_STYLE_VERTICAL         = 0x00000004;
	...
	public static class Builder{
		...
		@SuppressLint("InflateParams") public PromptDialog create(){
			...
			case VIEW_STYLE_TITLEBAR_SKYBLUE :
				...
				break;
			case VIEW_STYLE_VERTICAL :
				mView = LayoutInflater.from(context).inflate(R.layout.fynn_prompt_dialog_vertical, null);
				break;
